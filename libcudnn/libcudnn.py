...
_libcudnn.cudnnGetPooling2dForwardOutputDim.argtypes = [ctypes.c_void_p, ctypes.c_void_p,
                                           ctypes.c_void_p, ctypes.c_void_p,
                                           ctypes.c_void_p, ctypes.c_void_p]
def cudnnGetPooling2dForwardOutputDim(poolingDesc, inputDesc):
    """"
    ...
    status = _libcudnn.cudnnGetPooling2dForwardOutputDim(poolingDesc, inputDesc, ctypes.byref(n),
                                                 ctypes.byref(c), ctypes.byref(h), ctypes.byref(w))
    cudnnCheckStatus(status)
...
def cudnnBatchNormalizationBackward(handle, mode, alphaDataDiff, betaDataDiff, alphaParamDiff, betaParamDiff,
    ...
    *savedMean, *savedInvVariance
    ...
    status = _libcudnn.cudnnBatchNormalizationBackward(handle, mode, alphaDataRef, 
