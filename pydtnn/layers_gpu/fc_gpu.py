...
from ..tracers import PYDTNN_OPS_EVENT, PYDTNN_OPS_EVENTS, PYDTNN_OPS_FORWARD_CUDNN_SUM_BIASES, \
...
class FCGPU(LayerGPU, layers.FC):
    ...
    def initialize(self, prev_shape, need_dx, x):
        ...
        self.one_vec_gpu = gpuarray.to_GPU(LayerGPU, np.ones((self.model.batch_size,), self.model.dtype))
