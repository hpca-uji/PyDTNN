...
from ..tracers import PYDTNN_MDL_EVENT, PYDTNN_MDL_EVENTS, PYDTNN_MDL_FORWARD, PYDTNN_MDL_BACKWARD, \
...
class ConcatenationBlockGPU(LayerGPU, layers.ConcatenationBlock):
