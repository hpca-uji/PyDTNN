...
def im2row_nhwc_cython(x, int kh, int kw, int vpadding, int hpadding, int vstride, int hstride):
    ...
    if x.dtype == np.int8:
        im2row_nhwc_cython_inner_int8(rows, x, n, h, w, c, hh, ww, kh, kw, vpadding, hpadding, vstride, hstride)
    elif x.dtype == np.float32:
        im2row_nhwc_cython_inner_float32(rows, x, n, h, w, c, hh, ww, kh, kw, vpadding, hpadding, vstride, hstride)
    elif x.dtype == np.float64:
        im2row_nhwc_cython_inner_float64(rows, x, n, h, w, c, hh, ww, kh, kw, vpadding, hpadding, vstride, hstride)
    else:
...
def row2im_nhwc_cython(rows,
    ...
    if rows.dtype == np.int8:
        row2im_nhwc_cython_inner_int8(rows, x, n, h, w, c, hh, ww, kh, kw, vpadding, hpadding, vstride, hstride)
    elif rows.dtype == np.float32:
        row2im_nhwc_cython_inner_float32(rows, x, n, h, w, c, hh, ww, kh, kw, vpadding, hpadding, vstride, hstride)
    elif rows.dtype == np.float64:
        row2im_nhwc_cython_inner_float64(rows, x, n, h, w, c, hh, ww, kh, kw, vpadding, hpadding, vstride, hstride)
    else:
