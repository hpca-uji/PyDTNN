...
parser.add_argument('--train_sync_freq', type=int, default=0)
parser.add_argument('--val_sync_freq', type=int, default=0)
parser.add_argument('--test_sync_freq', type=int, default=0)
