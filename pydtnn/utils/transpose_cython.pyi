...
def transpose_0231_ikj_cython[T: _npDT](
    original: _npDT_4Dims[T], transposed: _npDT_4Dims[T]
) -> None:  # noqa: D103
    """
...
def transpose_0231_ijk_cython[T: _npDT](
    original: _npDT_4Dims[T], transposed: _npDT_4Dims[T]
) -> None:  # noqa: D103
    """
    Transposes a 4D matrix from (0,1,2,3) to (0,2,3,1).
...
def transpose_0312_ikj_cython[T: _npDT](
    original: _npDT_4Dims[T], transposed: _npDT_4Dims[T]
) -> None:  # noqa: D103
    """
...
def transpose_0312_ijk_cython[T: _npDT](
    original: _npDT_4Dims[T], transposed: _npDT_4Dims[T]
) -> None:  # noqa: D103
    """
    Transposes a 4D matrix from (0,1,2,3) to (0,3,1,2).
...
def transpose_1023_jik_cython[T: _npDT](
    original: _npDT_4Dims[T], transposed: _npDT_4Dims[T]
) -> None:  # noqa: D103
    """
...
def transpose_1023_ijk_cython[T: _npDT](
    original: _npDT_4Dims[T], transposed: _npDT_4Dims[T]
) -> None:  # noqa: D103
    """
    Transposes a 4D matrix from (0,1,2,3) to (0,2,3,1).
