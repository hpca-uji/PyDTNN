...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        _ds_group.add_argument("--augment-rotate-degree", type=factor, default=90.0, help="The maximum degree to rotate training images.Default: 90.0.")
        _ds_group.add_argument("--augment-brightness", type=factor, default=0.0, help="Probability to change the brightnes to training images. If the value is less or equal to 0 it is disabled. Default: 0.0.")
        ...
        _ds_group.add_argument("--transform-resize-size", type=int, default=300, help="New size of the images. Default: 300.")
        _ds_group.add_argument("--normalize", default=False, type=bool_lambda, help="Normalize dataset. Default: False.")
        _ds_group.add_argument("--normalize-offset", type=float, default=-0.45, help="Offset samples by a value. Default: -0.45.")
        _ds_group.add_argument("--normalize-scale", type=float, default=3.75, help="Scale samples by a value. Default: 3.75.")
