...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        _ds_group.add_argument("--augment-rotate", type=factor, default=0.5, help="Probability to rotate training images. If the value is less or equal to 0 it is disabled. Default: 0.0.")
        ...
        _ds_group.add_argument("--augment-brightness", type=factor, default=0.5, help="Probability to change the brightnes to training images. If the value is less or equal to 0 it is disabled. Default: 0.0.")
