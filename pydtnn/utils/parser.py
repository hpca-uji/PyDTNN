...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        _ds_group.add_argument("--augment-mask", type=factor, default=0.0, help="Probability to crop training images. If the value is less or equal to 0 it is disabled. Default: 0.0.")
        _ds_group.add_argument("--augment-mask-size", type=int, default=16, help="Size to crop training images. Default: 16.")
