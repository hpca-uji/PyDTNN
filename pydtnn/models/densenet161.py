...
def densenet161(input_shape: ArrayShape, output_shape: ArrayShape) -> Sequence[Layerable]:
    """
    Constructs a DenseNet161 model architecture.
    ...
    Returns:
        A sequence of layers representing the DenseNet161 model.
    """
