...
__all__ = ("densenet21k8",)


def densenet21k8(input_shape: ArrayShape, output_shape: ArrayShape) -> Sequence[Layerable]:
    """
    Constructs a DenseNet21 model architecture.
    ...
    Returns:
        A sequence of layers representing the DenseNet21 model.
    """
    ...
    blocks, growth_rate = [2, 2, 2, 2], 8  # DenseNet21
