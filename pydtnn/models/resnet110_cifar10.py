...
def create_resnet110_cifar10(model):
    model.add( Input(shape=(3, 32, 32)) )
    model.add( Conv2D(nfilters=16, filter_shape=(3, 3), stride=1, padding=1, weights_initializer="he_uniform") )
