...
def cublasCheckStatus(status: int) -> None:
    """
...
def cublasGetVersion(handle: int) -> int:
    """
...
class _cublas_version_req(object):  # noqa: N801
    """
...
def cublasSetStream(handle: int, id: int) -> None:
    """
...
def cublasGetStream(handle: int) -> int:
    """
...
def cublasGetPointerMode(handle: int) -> int:
    """
...
def cublasSetPointerMode(handle: int, mode: int) -> None:
    """
...
_libcublas.cublasIsamax_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIsamax(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIsamax.__doc__ = I_AMAX_doc.substitute(
...
_libcublas.cublasIdamax_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIdamax(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIdamax.__doc__ = I_AMAX_doc.substitute(
...
_libcublas.cublasIcamax_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIcamax(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIcamax.__doc__ = I_AMAX_doc.substitute(
    precision="single precision",
    real="complex",
...
_libcublas.cublasIzamax_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIzamax(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIzamax.__doc__ = I_AMAX_doc.substitute(
    precision="double precision",
    real="complex",
...
_libcublas.cublasIsamin_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIsamin(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIsamin.__doc__ = I_AMIN_doc.substitute(
    precision="single precision",
    real="real",
    data="np.random.rand(5).astype(np.float32)",
    func="cublasIsamin",
...
_libcublas.cublasIdamin_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIdamin(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIdamin.__doc__ = I_AMIN_doc.substitute(
    precision="double precision",
    real="real",
    data="np.random.rand(5).astype(np.float64)",
    func="cublasIdamin",
...
_libcublas.cublasIcamin_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIcamin(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIcamin.__doc__ = I_AMIN_doc.substitute(
    precision="single precision",
    real="complex",
    data="(np.random.rand(5)+1j*np.random.rand(5)).astype(np.complex64)",
    func="cublasIcamin",
...
_libcublas.cublasIzamin_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasIzamin(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> int:
...
cublasIzamin.__doc__ = I_AMIN_doc.substitute(
    precision="double precision",
    real="complex",
    data="(np.random.rand(5)+1j*np.random.rand(5)).astype(np.complex128)",
    func="cublasIzamin",
...
_libcublas.cublasSasum_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasSasum(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float32:
...
cublasSasum.__doc__ = _ASUM_doc.substitute(
    precision="single precision",
    real="real",
    data="np.random.rand(5).astype(np.float32)",
    func="cublasSasum",
...
_libcublas.cublasDasum_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasDasum(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float64:
...
cublasDasum.__doc__ = _ASUM_doc.substitute(
    precision="double precision",
    real="real",
    data="np.random.rand(5).astype(np.float64)",
    func="cublasDasum",
...
_libcublas.cublasScasum_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasScasum(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float32:
...
_libcublas.cublasDzasum_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasDzasum(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float64:
...
_libcublas.cublasSaxpy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
_libcublas.cublasDaxpy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasDaxpy(
    ...
    assert _libcublas
    status = _libcublas.cublasDaxpy_v2(
        handle, n, ctypes.byref(ctypes.c_double(alpha)), int(x), incx, int(y), incy
    )
    cublasCheckStatus(status)
...
_libcublas.cublasCaxpy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasCaxpy(
    ...
    assert _libcublas
    status = _libcublas.cublasCaxpy_v2(
        handle,
        n,
...
_libcublas.cublasZaxpy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasZaxpy(
    ...
    assert _libcublas
    status = _libcublas.cublasZaxpy_v2(
        handle,
        n,
...
_libcublas.cublasScopy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasScopy(
    handle: int, n: int, x: ctypes.c_void_p, incx: int, y: ctypes.c_void_p, incy: int
) -> None:
...
cublasScopy.__doc__ = _COPY_doc.substitute(
    precision="single precision",
    real="real",
    data="np.random.rand(5).astype(np.float32)",
    func="cublasScopy",
...
_libcublas.cublasDcopy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasDcopy.__doc__ = _COPY_doc.substitute(
    precision="double precision",
    real="real",
    data="np.random.rand(5).astype(np.float64)",
    func="cublasDcopy",
...
_libcublas.cublasCcopy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasCcopy.__doc__ = _COPY_doc.substitute(
    precision="single precision",
    real="complex",
...
_libcublas.cublasZcopy_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasZcopy.__doc__ = _COPY_doc.substitute(
    precision="double precision",
    real="complex",
...
_libcublas.cublasSdot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
_libcublas.cublasDdot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
_libcublas.cublasCdotu_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
_libcublas.cublasCdotc_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
_libcublas.cublasZdotu_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
_libcublas.cublasZdotc_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
_libcublas.cublasSnrm2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasSnrm2(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float32:
...
cublasSnrm2.__doc__ = _NRM2_doc.substitute(
    precision="single precision",
    real="real",
    data="np.float32(np.random.rand(5))",
    ret_type="numpy.float32",
...
_libcublas.cublasDnrm2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasDnrm2(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float64:
...
cublasDnrm2.__doc__ = _NRM2_doc.substitute(
    precision="double precision",
    real="real",
    data="np.float64(np.random.rand(5))",
    ret_type="numpy.float64",
...
_libcublas.cublasScnrm2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasScnrm2(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float32:
...
_libcublas.cublasDznrm2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasDznrm2(handle: int, n: int, x: ctypes.c_void_p, incx: int) -> np.float64:
...
_libcublas.cublasSrot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasSrot(
    ...
    assert _libcublas
    status = _libcublas.cublasSrot_v2(
        handle,
        n,
        int(x),
        incx,
...
_libcublas.cublasDrot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasDrot(
    ...
    assert _libcublas
    status = _libcublas.cublasDrot_v2(
        handle,
        n,
        int(x),
        incx,
...
_libcublas.cublasCrot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasCrot(
    ...
    assert _libcublas
    status = _libcublas.cublasCrot_v2(
        handle,
        n,
        int(x),
        incx,
...
_libcublas.cublasCsrot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasCsrot(
    ...
    assert _libcublas
    status = _libcublas.cublasCsrot_v2(
        handle,
        n,
        int(x),
        incx,
...
_libcublas.cublasZrot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasZrot(
    ...
    assert _libcublas
    status = _libcublas.cublasZrot_v2(
        handle,
        n,
        int(x),
        incx,
...
_libcublas.cublasZdrot_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasZdrot(
    ...
    assert _libcublas
    status = _libcublas.cublasZdrot_v2(
        handle,
        n,
        int(x),
        incx,
...
_libcublas.cublasSrotg_v2.argtypes = [
    _types.handle,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasSrotg(
    ...
    _s = ctypes.c_float()
    assert _libcublas
    status = _libcublas.cublasSrotg_v2(
        handle, ctypes.byref(_a), ctypes.byref(_b), ctypes.byref(_c), ctypes.byref(_s)
    )
    cublasCheckStatus(status)
...
_libcublas.cublasDrotg_v2.argtypes = [
    _types.handle,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasDrotg(
    handle: int, a: np.float64, b: np.float64
    ...
    _s = ctypes.c_double()
    assert _libcublas
    status = _libcublas.cublasDrotg_v2(
        handle, ctypes.byref(_a), ctypes.byref(_b), ctypes.byref(_c), ctypes.byref(_s)
    )
    cublasCheckStatus(status)
...
_libcublas.cublasCrotg_v2.argtypes = [
    _types.handle,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasCrotg(
    handle: int, a: np.complex64, b: np.complex64
) -> tuple[np.complex64, np.float32, np.complex64]:
    ...
    assert _libcublas
    status = _libcublas.cublasCrotg_v2(
        handle, ctypes.byref(_a), ctypes.byref(_b), ctypes.byref(_c), ctypes.byref(_s)
    )
    cublasCheckStatus(status)
...
_libcublas.cublasZrotg_v2.argtypes = [
    _types.handle,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasZrotg(
    handle: int, a: np.complex128, b: np.complex128
) -> tuple[np.complex128, np.float64, np.complex128]:
    ...
    assert _libcublas
    status = _libcublas.cublasZrotg_v2(
        handle, ctypes.byref(_a), ctypes.byref(_b), ctypes.byref(_c), ctypes.byref(_s)
    )
    cublasCheckStatus(status)
...
_libcublas.cublasSrotm_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasSrotm(
    ...
    assert _libcublas
    status = _libcublas.cublasSrotm_v2(
        handle, n, int(x), incx, int(y), incy, int(sparam.ctypes.data)
    )
    cublasCheckStatus(status)
...
_libcublas.cublasDrotm_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
def cublasDrotm(
    ...
    assert _libcublas
    status = _libcublas.cublasDrotm_v2(
        handle, n, int(x), incx, int(y), incy, int(sparam.ctypes.data)
    )
    cublasCheckStatus(status)
...
_libcublas.cublasSrotmg_v2.argtypes = [
    _types.handle,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
_libcublas.cublasDrotmg_v2.argtypes = [
    _types.handle,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasDrotmg(
    ...
    assert _libcublas
    status = _libcublas.cublasDrotmg_v2(
        handle,
        ctypes.byref(_d1),
        ctypes.byref(_d2),
        ctypes.byref(_x1),
...
_libcublas.cublasSscal_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
_libcublas.cublasDscal_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasDscal(handle: int, n: int, alpha: np.float64, x: ctypes.c_void_p, incx: int) -> None:
    """Scales a vector by a scalar (double precision real)."""
    assert _libcublas
    status = _libcublas.cublasDscal_v2(
        handle, n, ctypes.byref(ctypes.c_double(alpha)), int(x), incx
    )
    cublasCheckStatus(status)
...
_libcublas.cublasCscal_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasCscal(handle: int, n: int, alpha: np.complex64, x: ctypes.c_void_p, incx: int) -> None:
    """Scales a vector by a scalar (single precision complex)."""
    assert _libcublas
    status = _libcublas.cublasCscal_v2(
        handle, n, ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)), int(x), incx
    )
    cublasCheckStatus(status)
...
_libcublas.cublasCsscal_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasCsscal(handle: int, n: int, alpha: np.float32, x: ctypes.c_void_p, incx: int) -> None:
...
_libcublas.cublasZscal_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasZscal(handle: int, n: int, alpha: np.complex128, x: ctypes.c_void_p, incx: int) -> None:
    """Scales a vector by a scalar (double precision complex)."""
    assert _libcublas
    status = _libcublas.cublasZscal_v2(
        handle, n, ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)), int(x), incx
    )
    cublasCheckStatus(status)
...
_libcublas.cublasZdscal_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
def cublasZdscal(handle: int, n: int, alpha: np.float64, x: ctypes.c_void_p, incx: int) -> None:
    """Scales a complex vector by a real scalar (double precision)."""
    assert _libcublas
    status = _libcublas.cublasZdscal_v2(
        handle, n, ctypes.byref(ctypes.c_double(alpha)), int(x), incx
    )
    cublasCheckStatus(status)
...
_libcublas.cublasSswap_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasSswap.__doc__ = _SWAP_doc.substitute(
    precision="single precision",
    real="real",
    data="np.random.rand(5).astype(np.float32)",
    func="cublasSswap",
...
_libcublas.cublasDswap_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasDswap.__doc__ = _SWAP_doc.substitute(
    precision="double precision",
    real="real",
    data="np.random.rand(5).astype(np.float64)",
    func="cublasDswap",
...
_libcublas.cublasCswap_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasCswap.__doc__ = _SWAP_doc.substitute(
    precision="single precision",
    real="complex",
    data="(np.random.rand(5)+1j*np.random.rand(5)).astype(np.complex64)",
    func="cublasCswap",
...
_libcublas.cublasZswap_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_void_p,
    ctypes.c_int,
...
cublasZswap.__doc__ = _SWAP_doc.substitute(
    precision="double precision",
    real="complex",
    data="(np.random.rand(5)+1j*np.random.rand(5)).astype(np.complex128)",
    func="cublasZswap",
...
def cublasSgemv(
    ...
    assert _libcublas
    status = _libcublas.cublasSgemv_v2(
        handle,
        _CUBLAS_OP[trans],
        m,
        n,
...
cublasSgemv.__doc__ = _GEMV_doc.substitute(
    precision="single precision", real="real", a_type="numpy.float32"
)
...
def cublasDgemv(
    ...
    assert _libcublas
    status = _libcublas.cublasDgemv_v2(
        handle,
        _CUBLAS_OP[trans],
        m,
        n,
...
cublasDgemv.__doc__ = _GEMV_doc.substitute(
    precision="double precision", real="real", a_type="numpy.float64"
)
...
cublasCgemv.__doc__ = _GEMV_doc.substitute(
    precision="single precision", real="complex", a_type="numpy.complex64"
)
...
cublasZgemv.__doc__ = _GEMV_doc.substitute(
    precision="double precision", real="complex", a_type="numpy.complex128"
)
...
_libcublas.cublasSger_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
_libcublas.cublasDger_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasDger(
    ...
    assert _libcublas
    status = _libcublas.cublasDger_v2(
        handle, m, n, ctypes.byref(ctypes.c_double(alpha)), int(x), incx, int(y), incy, int(A), lda
    )
    cublasCheckStatus(status)
...
_libcublas.cublasCgerc_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasCgerc(
    ...
    assert _libcublas
    status = _libcublas.cublasCgerc_v2(
        handle,
        m,
        n,
        ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasCgeru_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasCgeru(
    ...
    assert _libcublas
    status = _libcublas.cublasCgeru_v2(
        handle,
        m,
        n,
        ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasZgerc_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasZgerc(
    ...
    assert _libcublas
    status = _libcublas.cublasZgerc_v2(
        handle,
        m,
        n,
        ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasZgeru_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasZgeru(
    ...
    assert _libcublas
    status = _libcublas.cublasZgeru_v2(
        handle,
        m,
        n,
        ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)),
...
def cublasSsbmv(
    ...
    assert _libcublas
    status = _libcublas.cublasSsbmv_v2(
        handle,
...
cublasSsbmv.__doc__ = _SBMV_doc.substitute(
    precision="single precision", real="real", a_type="numpy.float32"
)
...
def cublasDsbmv(
    ...
    assert _libcublas
    status = _libcublas.cublasDsbmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        k,
...
cublasDsbmv.__doc__ = _SBMV_doc.substitute(
    precision="double precision", real="real", a_type="numpy.float64"
)
...
cublasSspmv.__doc__ = _SPMV_doc.substitute(
    precision="single precision", real="real", a_type="numpy.float32"
)

_libcublas.cublasDspmv_v2.restype = int
_libcublas.cublasDspmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
cublasDspmv.__doc__ = _SPMV_doc.substitute(
    precision="double precision", real="real", a_type="numpy.float64"
)
...
_libcublas.cublasSspr_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasSspr(
    ...
    assert _libcublas
    status = _libcublas.cublasSspr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_float(alpha)),  # pyright: ignore[reportArgumentType]
...
_libcublas.cublasDspr_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasDspr(
    ...
    assert _libcublas
    status = _libcublas.cublasDspr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_double(alpha)),
...
_libcublas.cublasSspr2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasSspr2(
    ...
    assert _libcublas
    status = _libcublas.cublasSspr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_float(alpha)),  # pyright: ignore[reportArgumentType]
...
_libcublas.cublasDspr2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasDspr2(
    ...
    assert _libcublas
    status = _libcublas.cublasDspr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_double(alpha)),
...
def cublasSsymv(
    ...
    assert _libcublas
    status = _libcublas.cublasSsymv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_float(alpha)),  # pyright: ignore[reportArgumentType]
...
cublasSsymv.__doc__ = _SYMV_doc.substitute(
    precision="single precision", real="real", a_type="numpy.float32"
)
...
def cublasDsymv(
    ...
    assert _libcublas
    status = _libcublas.cublasDsymv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_double(alpha)),
...
cublasDsymv.__doc__ = _SYMV_doc.substitute(
    precision="double precision", real="real", a_type="numpy.float64"
)
...
def cublasSsyr(
    ...
    assert _libcublas
    status = _libcublas.cublasSsyr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_float(alpha)),  # pyright: ignore[reportArgumentType]
...
def cublasDsyr(
    ...
    assert _libcublas
    status = _libcublas.cublasDsyr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_double(alpha)),
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasCsyr_v2.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_int,
        ctypes.c_void_p,
...
def cublasCsyr(
    ...
    assert _libcublas
    status = _libcublas.cublasCsyr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)),
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasZsyr_v2.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_int,
        ctypes.c_void_p,
...
def cublasZsyr(
    ...
    assert _libcublas
    status = _libcublas.cublasZsyr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)),
...
def cublasSsyr2(
    ...
    assert _libcublas
    status = _libcublas.cublasSsyr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_float(alpha)),  # pyright: ignore[reportArgumentType]
...
def cublasDsyr2(
    ...
    assert _libcublas
    status = _libcublas.cublasDsyr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_double(alpha)),
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasCsyr2_v2.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_int,
        ctypes.c_void_p,
...
def cublasCsyr2(
    ...
    assert _libcublas
    status = _libcublas.cublasCsyr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)),
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasZsyr2_v2.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_int,
        ctypes.c_void_p,
...
def cublasZsyr2(
    ...
    assert _libcublas
    status = _libcublas.cublasZsyr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasStbmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasStbmv(
    ...
    assert _libcublas
    status = _libcublas.cublasStbmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasDtbmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasDtbmv(
    ...
    assert _libcublas
    status = _libcublas.cublasDtbmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasCtbmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasCtbmv(
    ...
    assert _libcublas
    status = _libcublas.cublasCtbmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasZtbmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasZtbmv(
    ...
    assert _libcublas
    status = _libcublas.cublasZtbmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasStbsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasStbsv(
    ...
    assert _libcublas
    status = _libcublas.cublasStbsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasDtbsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasDtbsv(
    ...
    assert _libcublas
    status = _libcublas.cublasDtbsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasCtbsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasCtbsv(
    ...
    assert _libcublas
    status = _libcublas.cublasCtbsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasZtbsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasZtbsv(
    ...
    assert _libcublas
    status = _libcublas.cublasZtbsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasStpmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasStpmv(
    ...
    assert _libcublas
    status = _libcublas.cublasStpmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasCtpmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasCtpmv(
    ...
    assert _libcublas
    status = _libcublas.cublasCtpmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasDtpmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasDtpmv(
    ...
    assert _libcublas
    status = _libcublas.cublasDtpmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasZtpmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasZtpmv(
    ...
    assert _libcublas
    status = _libcublas.cublasZtpmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasStpsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasStpsv(
    ...
    assert _libcublas
    status = _libcublas.cublasStpsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasDtpsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasDtpsv(
    ...
    assert _libcublas
    status = _libcublas.cublasDtpsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasCtpsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasCtpsv(
    ...
    assert _libcublas
    status = _libcublas.cublasCtpsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasZtpsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasZtpsv(
    ...
    assert _libcublas
    status = _libcublas.cublasZtpsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasStrmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasStrmv(
    ...
    assert _libcublas
    status = _libcublas.cublasStrmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasCtrmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasCtrmv(
    ...
    assert _libcublas
    status = _libcublas.cublasCtrmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasDtrmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasDtrmv(
    ...
    assert _libcublas
    status = _libcublas.cublasDtrmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasZtrmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasZtrmv(
    ...
    assert _libcublas
    status = _libcublas.cublasZtrmv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasStrsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasStrsv(
    ...
    assert _libcublas
    status = _libcublas.cublasStrsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasDtrsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasDtrsv(
    ...
    assert _libcublas
    status = _libcublas.cublasDtrsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasCtrsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasCtrsv(
    ...
    assert _libcublas
    status = _libcublas.cublasCtrsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasZtrsv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_int,
...
def cublasZtrsv(
    ...
    assert _libcublas
    status = _libcublas.cublasZtrsv_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        _CUBLAS_DIAG[diag],
...
_libcublas.cublasChpmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
_libcublas.cublasZhpmv_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
_libcublas.cublasCher_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasCher(
    ...
    assert _libcublas
    status = _libcublas.cublasCher_v2(
        handle, _CUBLAS_FILL_MODE[uplo], n, alpha, int(x), incx, int(A), lda
    )
    cublasCheckStatus(status)
...
_libcublas.cublasZher_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasZher(
    ...
    assert _libcublas
    status = _libcublas.cublasZher_v2(
        handle, _CUBLAS_FILL_MODE[uplo], n, alpha, int(x), incx, int(A), lda
    )
    cublasCheckStatus(status)
...
_libcublas.cublasCher2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasCher2(
    ...
    assert _libcublas
    status = _libcublas.cublasCher2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasZher2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasZher2(
    ...
    assert _libcublas
    status = _libcublas.cublasZher2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasChpr_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasChpr(
    ...
    assert _libcublas
    status = _libcublas.cublasChpr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_float(alpha)),  # pyright: ignore[reportArgumentType]
...
_libcublas.cublasZhpr_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasZhpr(
    ...
    assert _libcublas
    status = _libcublas.cublasZhpr_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(ctypes.c_double(alpha)),
...
_libcublas.cublasChpr2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasChpr2(
    ...
    assert _libcublas
    status = _libcublas.cublasChpr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuFloatComplex(alpha.real, alpha.imag)),
...
_libcublas.cublasZhpr2_v2.argtypes = [
    _types.handle,
    ctypes.c_int,
    ctypes.c_int,
    ctypes.c_void_p,
...
def cublasZhpr2(
    ...
    assert _libcublas
    status = _libcublas.cublasZhpr2_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        n,
        ctypes.byref(cuda.cuDoubleComplex(alpha.real, alpha.imag)),
...
def cublasSsyrk(
    ...
    assert _libcublas
    status = _libcublas.cublasSsyrk_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        n,
...
def cublasDsyrk(
    ...
    assert _libcublas
    status = _libcublas.cublasDsyrk_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        n,
...
def cublasCherk(
    ...
    assert _libcublas
    status = _libcublas.cublasCherk_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        n,
...
def cublasZherk(
    ...
    assert _libcublas
    status = _libcublas.cublasZherk_v2(
        handle,
        _CUBLAS_FILL_MODE[uplo],
        _CUBLAS_OP[trans],
        n,
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasSgetrfBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasDgetrfBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasCgetrfBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
if _cublas_version >= 5000:
    ...
    _libcublas.cublasZgetrfBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
def cublasSgetrsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasSgetrsBatched(
        handle,
        _CUBLAS_OP[trans],
        n,
        nrhs,
...
def cublasDgetrsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasDgetrsBatched(
        handle,
        _CUBLAS_OP[trans],
        n,
        nrhs,
...
def cublasCgetrsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasCgetrsBatched(
        handle,
        _CUBLAS_OP[trans],
        n,
        nrhs,
...
def cublasZgetrsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasZgetrsBatched(
        handle,
        _CUBLAS_OP[trans],
        n,
        nrhs,
...
if _cublas_version >= 5050:
    ...
    _libcublas.cublasSgetriBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
def cublasSgetriBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasSgetriBatched(
        handle, n, int(A), lda, int(P), int(C), ldc, int(info), batchSize
    )
    cublasCheckStatus(status)
...
if _cublas_version >= 5050:
    ...
    _libcublas.cublasDgetriBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
def cublasDgetriBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasDgetriBatched(
        handle, n, int(A), lda, int(P), int(C), ldc, int(info), batchSize
    )
    cublasCheckStatus(status)
...
if _cublas_version >= 5050:
    ...
    _libcublas.cublasCgetriBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
def cublasCgetriBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasCgetriBatched(
        handle, n, int(A), lda, int(P), int(C), ldc, int(info), batchSize
    )
    cublasCheckStatus(status)
...
if _cublas_version >= 5050:
    ...
    _libcublas.cublasZgetriBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_void_p,
        ctypes.c_int,
...
def cublasZgetriBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasZgetriBatched(
        handle, n, int(A), lda, int(P), int(C), ldc, int(info), batchSize
    )
    cublasCheckStatus(status)
...
if _cublas_version >= 5000:
    _libcublas.cublasSgelsBatched.restype = _libcublas.cublasDgelsBatched.restype = (
        _libcublas.cublasCgelsBatched.restype
    ) = _libcublas.cublasZgelsBatched.restype = int
    _libcublas.cublasSgelsBatched.argtypes = _libcublas.cublasDgelsBatched.argtypes = (
        _libcublas.cublasCgelsBatched.argtypes
    ) = _libcublas.cublasZgelsBatched.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_int,
        ctypes.c_int,
...
def cublasSgelsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasSgelsBatched(
        handle,
        _CUBLAS_OP[trans],
        m,
        n,
...
def cublasDgelsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasDgelsBatched(
        handle,
        _CUBLAS_OP[trans],
        m,
        n,
...
def cublasCgelsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasCgelsBatched(
        handle,
        _CUBLAS_OP[trans],
        m,
        n,
...
def cublasZgelsBatched(
    ...
    assert _libcublas
    status = _libcublas.cublasZgelsBatched(
        handle,
        _CUBLAS_OP[trans],
        m,
        n,
...
if _cublas_version >= 5000:
    _libcublas.cublasSdgmm.restype = _libcublas.cublasDdgmm.restype = (
        _libcublas.cublasCdgmm.restype
    ) = _libcublas.cublasZdgmm.restype = int

    _libcublas.cublasSdgmm.argtypes = _libcublas.cublasDdgmm.argtypes = (
        _libcublas.cublasCdgmm.argtypes
    ) = _libcublas.cublasZdgmm.argtypes = [
        _types.handle,
        ctypes.c_int,
        ctypes.c_int,
        ctypes.c_int,
...
def cublasSdgmm(
    ...
    assert _libcublas
    status = _libcublas.cublasSdgmm(
        handle, _CUBLAS_SIDE_MODE[side], m, n, int(A), lda, int(x), incx, int(C), ldc
    )
    cublasCheckStatus(status)
...
if _cublas_version >= 8000:
    _libcublas.cublasSgemmStridedBatched.restype = _libcublas.cublasDgemmStridedBatched.restype = (
    ...
    _libcublas.cublasSgemmStridedBatched.argtypes = (
        ...
        _libcublas.cublasZgemmStridedBatched.argtypes
    ) = [
        ctypes.c_void_p,
        ctypes.c_int,
        ctypes.c_int,
