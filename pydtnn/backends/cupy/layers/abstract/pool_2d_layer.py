...
class AbstractPool2DLayerCUPY(AbstractPool2DLayer[np.ndarray], LayerCUPY):
    ...
    def initialize(self, prev_shape: ArrayShape, x: np.ndarray | None = None):
        ...
        match self.model.tensor_format:
            ...
            case _:
                raise TypeError(f"Function: \'AbstractPool2DLayerCUPY\'. Error:\n\tFormat: \'{self.model.tensor_format}\' not supported.")
    ...
    def forward(self, x: np.ndarray) -> np.ndarray:
        ...
        raise NotImplementedError(f"Class \'AbstractPool2DLayerCUPY\'. Error: {msg}")
