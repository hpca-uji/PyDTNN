...
class LeakyReluCupy(LeakyReluNumpy, ActivationCupy):
    ...
    def forward(self, x: np.ndarray) -> np.ndarray:
        ...
        self.fwd_kernel(self.model.cuda_grid, self.model.cuda_block, (x, self.y, self.mask, self.negative_slope, x.size))
        return self.y
    ...
    def backward(self, dy: np.ndarray) -> np.ndarray:
        ...
        """
        self.bwd_kernel(self.model.cuda_grid, self.model.cuda_block, (dy, dy, self.mask, self.negative_slope, dy.size))
        return dy
