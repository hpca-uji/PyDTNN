"""
Cython-accelerated pointwise convolution utilities for PyDTNN.
"""

from pydtnn.backends.cython.utils.base import _npDT, _npDT_2Dims, _npDT_4Dims

def pointwise_conv_cython[T: _npDT](
    x: _npDT_4Dims[T], k: _npDT_2Dims[T], out: _npDT_4Dims[T]
) -> None:
    """
    Performs a pointwise convolution operation using Cython optimization.
