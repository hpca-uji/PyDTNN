...
from pydtnn.backends.cython.utils.max_pool_2d_nhwc_cython import (
    max_pool_2d_bwd_nhwc_cython, max_pool_2d_fwd_nhwc_cython)
from pydtnn.backends.cython.utils.max_pool_2d_nchw_cython import (
    max_pool_2d_bwd_nchw_cython, max_pool_2d_fwd_nchw_cython)
