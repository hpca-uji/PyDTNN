...
If you want to add a new GPU layer:
    ...
    2) define your layer class as derived from LayerGPUMixin and Layer (or any Layer derived class),
...
# Search this module for LayerGPUMixin derived classes and expose them
get_derived_classes(LayerGPUMixin, locals())
