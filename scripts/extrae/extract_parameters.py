...
def extract_parameters() -> None:  # noqa: C901
    ...
    c.print("#")
    c.print("# It has been automatically generated with 'extract_parameters.py' from the next files:")
    c.print("#")
    for model, file in models_files.items():
        c.print(f"#   {model} <- {file}")
    c.print("#")
    c.print("# Those parameters that have been edited on the script have been prepended with an '*'.")
    c.print("#")
